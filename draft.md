...
docname: draft-dalal-deprecation-header-03
category: std
...
- Description: Deprecation header is incorporated in code generated by conjure-java, a CLI to generate Java POJOs and interfaces from [Conjure API definitions](https://github.com/palantir/conjure)
- Reference: https://github.com/palantir/conjure-java

Organization: Registration Protocols Extensions (IETF) (Internet Draft)
